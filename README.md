...
| 고객지원 | 구현됨 | 1대1 문의와 게시글 신고 접수를 지원합니다. |
...
| 일정 | 구현됨 | 반려동물 일정 생성·목록·상세·수정·삭제와 루틴 관리가 API/UI에 연결되어 있습니다. 장소는 직접 입력하며 지도 검색은 제공하지 않습니다. Android FCM 일정 알림과 알림 클릭 이동이 연결되어 있습니다. |
